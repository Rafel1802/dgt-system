...
gz_file = "u355625773_kiuq_system.sql.gz"
...
scp_cmd = [
    ...
    gz_file,
    "u355625773@157.173.215.124:domains/lightcyan-weasel-711536.hostingersite.com/"
]
run_cmd(scp_cmd)
...
ssh_cmd = [
    ...
    zcat ../u355625773_kiuq_system.sql.gz | mysql -u "$DB_USER" -p"$DB_PASS" "$DB_NAME" &&
    rm ../u355625773_kiuq_system.sql.gz
    """
]
run_cmd(ssh_cmd)
