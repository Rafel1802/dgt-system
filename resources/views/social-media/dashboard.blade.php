...
<div class="page-header flex flex-wrap gap-4 items-end justify-between mb-8">
    ...
    <div class="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
        ...
        <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            @if($canManageClasses)
            <a wire:navigate.hover href="{{ route('social-media.manage') }}" class="btn btn-secondary flex-1 sm:flex-none justify-center flex items-center gap-2 text-xs sm:text-sm">
            ...
            <a wire:navigate.hover href="{{ route('social-media.analytics.index') }}" class="btn btn-secondary flex-1 sm:flex-none justify-center flex items-center gap-2 text-xs sm:text-sm">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <a wire:navigate.hover href="{{ route('social-media.reports.index') }}" class="btn btn-primary flex-1 sm:flex-none justify-center flex items-center gap-2 text-xs sm:text-sm">
...
@if($classesWithStats->isEmpty())
    <div class="col-span-full">
        <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-12 text-center shadow-sm">
            ...
            @if($canManageClasses)
                <a wire:navigate.hover href="{{ route('social-media.manage') }}" class="btn btn-primary mt-6">Create Your First Class</a>
            @endif
        </div>
    </div>
@endif
