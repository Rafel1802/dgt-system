...
<div class="animate-fade-in">
  ...
  {{-- ── Search ────────────────────────────────────────────────────────────── --}}
  <form method="GET" action="{{ route('crm.logistics.shipments.index') }}" class="card p-4 mb-5">
    <div class="flex flex-wrap gap-3 items-end">
      ...
      <div class="flex gap-2">
        ...
        <a href="{{ route('crm.logistics.shipments.index') }}" class="btn btn-secondary py-2 text-sm">Reset</a>
      </div>
    </div>
  </form>
