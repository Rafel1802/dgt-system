...
<div class="mb-6 flex items-center gap-2 overflow-x-auto hide-scrollbar border-b border-slate-200 dark:border-slate-700 pb-0 -mb-px">
    @php
        $tabs = [
            'build'          => ['label' => 'Build Website',       'count' => $tabCounts['build'],            'icon' => 'M12 4.5v15m7.5-7.5h-15',                                                                       'color' => 'slate'],
            'build-progress' => ['label' => 'Build Progress',      'count' => $tabCounts['build-progress'],    'icon' => 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z', 'color' => 'blue'],
            'live'           => ['label' => 'Live Websites',        'count' => $tabCounts['live'],             'icon' => 'M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',                                'color' => 'emerald'],
            'maintenance'    => ['label' => 'Update / Maintenance', 'count' => $tabCounts['maintenance'],      'icon' => 'M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l5.654-4.654', 'color' => 'orange'],
        ];

        $tabs['qc-error'] = ['label' => 'QC Error', 'count' => $tabCounts['qc-error'], 'icon' => 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z', 'color' => 'red'];
        $tabs['supervisor-error'] = ['label' => 'Supervisor Error', 'count' => $tabCounts['supervisor-error'], 'icon' => 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z', 'color' => 'rose'];
        $colorMap = [
